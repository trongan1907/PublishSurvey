let formSection = document.querySelector("#myList");
  ...
  let sectionDetails = `
    ...
    <div class="section section-${numberSection}">
        <div class="section-title">
            <input type="text" name="" id="" class="section-title_input element" placeholder="Nhập tiêu đề section">
        </div>
        <div class="section-description">
            <input type="text" name="" id="" class="section-description_input element" placeholder="Nhập mô tả chi tiết">
        </div>
        <div class="container section-question section-question-${numberSection}">
        <div class="question">
        <div class="question-list">
            <div class="question-list-title">
                <input class="question-list-title_input element" placeholder="Câu hỏi không có tiêu đề">
        ...
        <div class="option-box">
            <div class="option-element">
                <i class="fa-solid fa-plus" onclick="addQuestion(${numberSection})"></i>
                <i class="fa-solid fa-trash" onclick="delQuestion(this)"></i>
                <i class="fa-solid fa-chevron-up ClickUP" aria-hidden="true" onclick="ChangePositionUP(this)"></i>
                <i class="fa-solid fa-chevron-down ClickDOWN" aria-hidden="true" onclick="ChangePositionDOWN(this)"></i>
            </div>
        </div>
    </div>
        </div>
    ...
    <div class="option-section">
        <div class="option-element">
            <i class="fa-solid fa-plus" onclick="addSection()"></i>
            <i class="fa-solid fa-trash" onclick="delSection(this)"></i>
            <i class="fa-solid fa-chevron-up ClickUP" aria-hidden="true" onclick="ChangePositionUP(this)"></i>
            <i class="fa-solid fa-chevron-down ClickDOWN" aria-hidden="true" onclick="ChangePositionDOWN(this)"></i>
        </div>
    </div>
    ...
    `;
  formSection.insertAdjacentHTML("beforeend", sectionDetails);
}
function delSection(element){
    element.parentElement.parentElement.parentElement.remove();
}
function addQuestion(numberClick){
    typeInput = 'radio';
    numberAnswer=1;
    numberQuestion++;
    let formQuestion = document.querySelector('.section-question-'+numberClick);
    let questionDetails =
    `
    <div class="question">
                        <div class="question-list">
                        ...
                        <div class="option-box">
                            <div class="option-element">
                                <i class="fa-solid fa-plus" onclick="addQuestion(${numberClick})"></i>
                                <i class="fa-solid fa-trash" onclick="delQuestion(this)"></i>
                                <i class="fa-solid fa-chevron-up ClickUP" aria-hidden="true" onclick="ChangePositionUP(this)"></i>
                                <i class="fa-solid fa-chevron-down ClickDOWN" aria-hidden="true" onclick="ChangePositionDOWN(this)"></i>
                            </div>
