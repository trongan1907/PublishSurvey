...
// Validate
function checkCreateTemplate(idForm) {
    try {
                ...
                if (x.querySelector('.answer-list-content_input') == null) {
                    ...
                    for (let m = 0; m < answerChoice.length; m++) {
                        if (answerChoice[m].value.length > 500) {
                            ...
                            answerChoice[m].parentElement.parentElement.querySelector('small').innerHTML = "Please enter less than 150 words"
                        }
